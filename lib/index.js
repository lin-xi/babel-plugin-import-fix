...
exports.default = function (_ref) {
  ...
  function Program(path, _ref2) {
    ...
    if (!plugins) {
      opts = _moduleConfig.config;
      if (Array.isArray(opts)) {
        opts = _moduleConfig.config.concat(opts);
      }
      plugins = opts.map(function (_ref3) {
        ...
        return new _Plugin2.default(libraryName, libraryDirectory, getPath, style, camel2DashComponentName, camel2UnderlineComponentName, fileName, types);
      });
    }
